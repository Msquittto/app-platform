...
public class UserFeedbackController extends AbstractController {
     ...
     */
    @PostMapping(value = "/feedback", summary = "创建用户反馈记录", description = "该接口用于创建用户对一个对话实例的反馈记录。")
     ...
     */
    @PatchMapping(value = "/feedback/{instanceId}", summary = "更新用户反馈记录", description = "该接口用于更新用户对一个对话实例反馈记录。")
     ...
     */
    @GetMapping(value = "/feedback/{instanceId}", summary = "查询用户反馈记录", description = "该接口可以通过待查询实例的唯一标识符来查询实例的反馈记录。")
